...
-- positive x-values.
alignXMin :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
alignXMin = align (negateV unitX)

snugXMin :: (Fractional (Scalar (V a)), Alignable a, Traced a,
      HasOrigin a, V a ~ v, ThreeD v) => a -> a
snugXMin = snug (negateV unitX)

-- | Translate the diagram along unitX so that all points have
-- negative x-values.
alignXMax :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
...
-- negative y-values.
alignYMax :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
...
-- | Translate the diagram along unitY so that all points have
-- positive y-values.
alignYMin :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
...
-- negative z-values.
alignZMax :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
...
-- | Translate the diagram along unitZ so that all points have
-- positive z-values.
alignZMin :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
...
--   to the bottom edge.
alignY :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => Scalar v -> a -> a
...
--   argument of @1@ corresponding to the top edge and @(-1)@ corresponding
--   to the bottom edge.
alignZ :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => Scalar v -> a -> a
...
centerX  :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
...
centerY  :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
...
centerZ  :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
...
centerXY :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
...
centerXZ :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
...
centerYZ :: (Alignable a, HasOrigin a, V a ~ v, ThreeD v) => a -> a
