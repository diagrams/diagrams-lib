...
alignT :: (Alignable a, HasOrigin a, V a ~ v, TwoD v) => a -> a
alignT = align unitY
...
alignB :: (Alignable a, HasOrigin a, V a ~ v, TwoD v) => a -> a
...
alignTL, alignTR, alignBL, alignBR :: (Alignable a, HasOrigin a, V a ~ v, TwoD v) => a -> a
...
snugTL, snugTR, snugBL, snugBR
  :: (Fractional (Scalar (V a)), Alignable a, Traced a, HasOrigin a, V a ~ v, TwoD v)
   => a -> a
snugTL = snugT . snugL
snugTR = snugT . snugR
snugBL = snugB . snugL
...
--   to the bottom edge.
alignY :: (Alignable a, HasOrigin a, V a ~ v, TwoD v) => Scalar v -> a -> a
...
centerX  :: (Alignable a, HasOrigin a, V a ~ v, TwoD v) => a -> a
...
centerY  :: (Alignable a, HasOrigin a, V a ~ v, TwoD v) => a -> a
...
centerXY :: (Alignable a, HasOrigin a, V a ~ v, TwoD v) => a -> a
centerXY = center
