...
tiny      = Normalized 0.01   `atLeast` Output 4
verySmall = Normalized 0.02   `atLeast` Output 8
small     = Normalized 0.0375 `atLeast` Output 12
normal    = Normalized 0.05   `atLeast` Output 20
large     = Normalized 0.075  `atLeast` Output 30
veryLarge = Normalized 0.125  `atLeast` Output 50
huge      = Normalized 0.2    `atLeast` Output 75
