...
d3c10 = listArray (0,9) $ map sRGB24read
...
d3c20 = listArray ((0,0),(9,1)) $ map sRGB24read
...
d3Pair k n = d3c20 ! ((n `mod` 10),(k `mod` 2))

d3c20bc ::  Array (Int, Int) (Colour Double)
d3c20bc = listArray ((0,0),(9,3)) $ map sRGB24read
...
d3Quad k n =d3c20bc ! ((n `mod` 10),(k `mod` 4))
